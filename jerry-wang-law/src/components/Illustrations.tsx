/**
 * The site's drawn marks: the monogram, one small mark per practice area
 * (wayfinding in the menu, and a stand-in until that area's photograph is
 * supplied), and the interface icons.
 *
 * Photographs carry the site; these are the small print.
 */
